...
- `git fetch` - Receives changes from a remote repo into your tracking branch
- `git pull` - Receives changes from a remote branch into your tracking branch and merge them into a local branch
